...
def SendView(item_id, proxy, timeout, proxytype):
    ...
    try:
        ...
        try:
            ...
            TotalSendedView += 1
            print(Colorate.Horizontal(Colors.green_to_white, f"made: {TotalSendedView} shares"))
            Title(f"Thread :{str(active_count()-1)} / tried :{TotalFailedReq} times")
    except:
        pass
...
if (__name__ == "__main__"):
    Clear()
    print(Colorate.Horizontal(Colors.red_to_white, f"Notice:"))
    print(Colorate.Horizontal(Colors.blue_to_white, f"The ViewBot is currently working but works really slow!"))
    ...
    print(Colorate.Horizontal(Colors.red_to_white, f"started sharing! notice shares in aproximately 5-7 minutes!"))
    print(Colorate.Horizontal(Colors.blue_to_purple, f"made with <3 by yzde!"))
